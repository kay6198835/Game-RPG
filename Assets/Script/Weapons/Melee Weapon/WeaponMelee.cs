...
public class WeaponMelee : Weapon
{
    ...
    {
        if (holder.Core.Player.Data.StatsBehavior.Skill == PlayerInputHandler.SkillType.Ability)
        {
            currentAbilitySO = statsMelee.AbilityWeapon;
        }
        else if(holder.Core.Player.Data.StatsBehavior.Skill == PlayerInputHandler.SkillType.Special)
        {
    ...
    {
        centerAttackPosition = (Vector2)player.transform.position + player.Data.StatsBehavior.DirectionMouseVector.normalized * currrentSA.attackRange;
    }
